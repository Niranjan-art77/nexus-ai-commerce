                ...
                {selectedSearchProduct ? (
                  <div className="space-y-3 font-mono text-[11px] text-gray-300">
                    <p className="leading-relaxed font-light">
                      &gt; Deep auditing of pricing history completed. <strong>Nexus Store</strong> features the absolute lowest price at <strong>${selectedSearchProduct.price}</strong>, yielding a net savings of <strong>8%</strong> compared to standard listings.
                    </p>
                    <div className="p-3 bg-[#ff9900]/5 border border-[#ff9900]/20 rounded-xl">
                      ...
                      Highly Recommended. Direct priority dispatch available via current session.
                    </div>
                  </div>
                ) : (
                  <div className="h-40 flex flex-col items-center justify-center text-center text-gray-600">
                    ...
                    <span>Search or select a product to generate AI recommendations.</span>
                  </div>
                )}
              </div>
                ...
                <button
                  onClick={() => {
                    dispatch(addToCartAction({
                      ...
                      price: selectedSearchProduct.price,
                      quantity: 1,
                      image: selectedSearchProduct.images?.[0] || ""
                    }));
                    alert(`${selectedSearchProduct.name} added to cart from AI recommendations!`);
                  }}
